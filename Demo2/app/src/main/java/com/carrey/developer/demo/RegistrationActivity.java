package com.carrey.developer.demo;
...
public class RegistrationActivity extends AppCompatActivity {
    ...
    String url = "http://192.168.1.7/another1/register.php";
    ...
    public void moveToLogin(View view) {
        ...
        startActivity(new Intent(getApplicationContext(), com.carrey.developer.demo.LoginActivity.class));
        finish();
    }
